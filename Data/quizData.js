...
export const quizData = [
  {
    ...
    options: [
      {
        correct: false,
        text: "`Sajeeb` and `undefined`",
      },
      {
        correct: false,
        text: "`Sajeeb` and `ReferenceError`",
      },
      {
        correct: false,
  ...
  },
  {
    ...
    explanation:
      "The unary plus tries to convert an operand to a number. `true` is `1`, and `false` is `0`.\n\nThe string `'Sajeeb'` is a truthy value. What we're actually asking, is \"is this truthy value falsy?\". This returns `false`.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    code: 'function Person(firstName, lastName) {\n  this.firstName = firstName;\n  this.lastName = lastName;\n}\n\nconst member = new Person("Sajeeb", "Ahmed");\nPerson.getFullName = function() {\n  return `${this.firstName} ${this.lastName}`;\n};\n\nconsole.log(member.getFullName());',
    options: [
      {
        correct: true,
        text: "`TypeError`",
  ...
  },
  {
    ...
    code: 'function Person(firstName, lastName) {\n  this.firstName = firstName;\n  this.lastName = lastName;\n}\n\nconst Sajeeb= new Person("Sajeeb", "Ahmed");\nconst sarah = Person("Sarah", "Smith");\n\nconsole.log(Sajeeb);\nconsole.log(sarah);',
    options: [
      {
        correct: true,
        text: '`Person {firstName: "Sajeeb", lastName: "Ahmed"}` and `undefined`',
      },
      {
        correct: false,
        text: '`Person {firstName: "Sajeeb", lastName: "Ahmed"}` and `Person {firstName: "Sarah", lastName: "Smith"}`',
      },
      {
        correct: false,
        text: '`Person {firstName: "Sajeeb", lastName: "Ahmed"}` and `{}`',
      },
      {
        correct: false,
        text: '`Person {firstName: "Sajeeb", lastName: "Ahmed"}` and `ReferenceError`',
      },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        correct: false,
        text: '`"Sajeeb"` `21` `["", " is ", " years old"]`',
      },
      {
        correct: true,
        text: '`["", " is ", " years old"]` `"Sajeeb"` `21`',
      },
      {
        correct: false,
        text: '`"Sajeeb"` `["", " is ", " years old"]` `21`',
      },
    ],
    explanation:
  ...
  },
  {
    ...
    code: 'String.prototype.giveSajeebPizza = () => {\n  return "Just give Sajeebpizza already!";\n};\n\nconst name = "Sajeeb";\n\nname.giveSajeebPizza();',
    options: [
      {
        correct: true,
        text: '`"Just give Sajeebpizza already!"`',
      },
      {
        correct: false,
  ...
  },
  {
    ...
    code: 'const person = { name: "Sajeeb" };\n\nfunction sayHi(age) {\n  return `${this.name} is ${age}`;\n}\n\nconsole.log(sayHi.call(person, 21));\nconsole.log(sayHi.bind(person, 21));',
    options: [
      {
        correct: false,
        text: "`undefined is 21` `Sajeebis 21`",
      },
      {
        correct: false,
      ...
      {
        correct: false,
        text: "`Sajeebis 21` `Sajeebis 21`",
      },
      {
        correct: true,
        text: "`Sajeebis 21` `function`",
      },
    ],
    explanation:
  ...
  },
  {
    ...
    code: 'const user = { name: "Sajeeb", age: 21 };\nconst admin = { admin: true, ...user };\n\nconsole.log(admin);',
    options: [
      {
        correct: false,
        text: '`{ admin: true, user: { name: "Sajeeb", age: 21 } }`',
      },
      {
        correct: true,
        text: '`{ admin: true, name: "Sajeeb", age: 21 }`',
      },
      {
        correct: false,
        text: '`{ admin: true, user: ["Sajeeb", 21] }`',
      },
      {
        correct: false,
        text: "`{ admin: true }`",
    ...
    explanation:
      'It\'s possible to combine objects using the spread operator `...`. It lets you create copies of the key/value pairs of one object, and add them to another object. In this case, we create copies of the `user` object, and add them to the `admin` object. The `admin` object now contains the copied key/value pairs, which results in `{ admin: true, name: "Sajeeb", age: 21 }`.',
  },
  {
    id: 61,
    ...
    options: [
      {
        correct: false,
        text: '`{ name: "Sajeeb", age: 21 }`, `["name", "age"]`',
      },
      {
        correct: true,
        text: '`{ name: "Sajeeb", age: 21 }`, `["name"]`',
      },
      {
        correct: false,
        text: '`{ name: "Sajeeb"}`, `["name", "age"]`',
      },
      {
        correct: false,
        text: '`{ name: "Sajeeb"}`, `["age"]`',
      },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: false,
        text: '`"{"username": "SajeebAhmed", "level":19, "health":90}"`',
      },
    ],
    explanation:
  ...
  },
  {
    ...
    code: 'const name = "Sajeeb Ahmed"\nconsole.log(name.padStart(13))\nconsole.log(name.padStart(2))',
    options: [
      {
        correct: false,
        text: '`"Sajeeb Ahmed"`, `"Sajeeb Ahmed"`',
      },
      {
        correct: false,
        text: '`"           Sajeeb Ahmed"`, `"  Sajeeb Ahmed"` (`"[13x whitespace]Sajeeb Ahmed"`, `"[2x whitespace]Sajeeb Ahmed"`)',
      },
      {
        correct: true,
        text: '`" Sajeeb Ahmed"`, `"Sajeeb Ahmed"` (`"[1x whitespace]Sajeeb Ahmed"`, `"Sajeeb Ahmed"`)',
      },
      {
        correct: false,
        text: '`"Sajeeb Ahmed"`, `"Lyd"`,',
      },
    ],
    explanation:
      'With the `padStart` method, we can add padding to the beginning of a string. The value passed to this method is the _total_ length of the string together with the padding. The string `"Sajeeb Ahmed"` has a length of `12`. `name.padStart(13)` inserts 1 space at the start of the string, because 12 + 1 is 13.\n\nIf the argument passed to the `padStart` method is smaller than the length of the array, no padding will be added.',
  },
  {
    id: 70,
  ...
  },
  {
    ...
    code: 'const { name: myName } = { name: "Sajeeb" };\n\nconsole.log(name);',
    options: [
      {
        correct: false,
        text: '`"Sajeeb"`',
    ...
    explanation:
      'When we unpack the property `name` from the object on the right-hand side, we assign its value `"Sajeeb"` to a variable with the name `myName`.\n\nWith `{ name: myName }`, we tell JavaScript that we want to create a new variable called `myName` with the value of the `name` property on the right-hand side.\n\nSince we try to log `name`, a variable that is not defined, a ReferenceError gets thrown.',
  },
  {
    id: 77,
  ...
  },
  {
    ...
    explanation:
      "By default, arguments have the value of `undefined`, unless a value has been passed to the function. In this case, we didn't pass a value for the `name` argument. `name` is equal to `undefined` which gets logged.\n\nIn ES6, we can overwrite this default `undefined` value with default parameters. For example:\n\n`function sayHi(name = \"Sajeeb\") { ... }`\n\nIn this case, if we didn't pass a value or if we passed `undefined`, `name` would always be equal to the string `Sajeeb`",
  },
  {
    id: 82,
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: false,
        text: '`{ name: "Sajeeb", age: 21, city: "Amsterdam" }`',
      },
      {
        correct: false,
        text: '`{ name: "Sajeeb", age: 21, city: undefined }`',
      },
      {
        correct: false,
        text: '`"Amsterdam"`',
  ...
  },
  {
    ...
    code: '// module.js \nexport default () => "Hello world"\nexport const name = "Sajeeb"\n\n// index.js \nimport * as data from "./module"\n\nconsole.log(data)',
    options: [
      {
        correct: true,
        text: '`{ default: function default(), name: "Sajeeb" }`',
      },
      {
        correct: false,
      ...
      {
        correct: false,
        text: '`{ default: "Hello world", name: "Sajeeb" }`',
      },
      {
        correct: false,
  ...
  },
  {
    ...
    code: 'function giveSajeebPizza() {\n  return "Here is pizza!"\n}\n\nconst giveSajeebChocolate = () => "Here\'s chocolate... now go hit the gym already."\n\nconsole.log(giveSajeebPizza.prototype)\nconsole.log(giveSajeebChocolate.prototype)',
    options: [
      {
        correct: false,
    ...
    explanation:
      "Regular functions, such as the `giveSajeebPizza` function, have a `prototype` property, which is an object (prototype object) with a `constructor` property. Arrow functions however, such as the `giveSajeebChocolate` function, do not have this `prototype` property. `undefined` gets returned when trying to access the `prototype` property using `giveSajeebChocolate.prototype`.",
  },
  {
    id: 93,
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: false,
        text: '`[1, [2, 3, 4]]` and `{ name: "Sajeeb", age: 21 }`',
      },
      {
        correct: false,
        text: '`[1, 2, 3, 4]` and `{ name: "Sajeeb", age: 21 }`',
      ...
      {
        correct: false,
        text: '`Error` and `{ name: "Sajeeb", age: 21 }`',
      },
    ],
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: true,
        text: "`3`, `Sajeeb2`, `[object Object]2`",
      },
      {
        correct: false,
        text: '`"12"`, `Sajeeb2`, `[object Object]2`',
      },
    ],
    explanation:
      'The `+` operator is not only used for adding numerical values, but we can also use it to concatenate strings. Whenever the JavaScript engine sees that one or more values are not a number, it coerces the number into a string. \n\nThe first one is `1`, which is a numerical value. `1 + 2` returns the number 3.\n\nHowever, the second one is a string `"Sajeeb"`. `"Sajeeb"` is a string and `2` is a number: `2` gets coerced into a string. `"Sajeeb"` and `"2"` get concatenated, which results in the string `"Sajeeb2"`. \n\n`{ name: "Sajeeb" }` is an object. Neither a number nor an object is a string, so it stringifies both. Whenever we stringify a regular object, it becomes `"[object Object]"`. `"[object Object]"` concatenated with `"2"` becomes `"[object Object]2"`.',
  },
  {
    id: 104,
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: true,
        text: '`{name: "Sajeeb", age: 22}`',
      },
      {
        correct: false,
        text: '`{name: "Sajeeb", age: 23}`',
      },
    ],
    explanation:
      'Both the `changeAge` and `changeAgeAndName` functions have a default parameter, namely a _newly_ created object `{ ...person }`. This object has copies of all the key/values in the `person` object. \n\nFirst, we invoke the `changeAge` function and pass the `person` object as its argument. This function increases the value of the `age` property by 1. `person` is now `{ name: "Sajeeb", age: 22 }`.\n\nThen, we invoke the `changeAgeAndName` function, however we don\'t pass a parameter. Instead, the value of `x` is equal to a _new_ object: `{ ...person }`. Since it\'s a new object, it doesn\'t affect the values of the properties on the `person` object. `person` is still equal to `{ name: "Sajeeb", age: 22 }`.',
  },
  {
    id: 117,
  ...
  },
  {
    ...
    options: [
      ...
      {
        correct: true,
        text: "`Mara` `undefined` `Sajeeb Ahmed` `undefined`",
      },
      {
        correct: false,
        text: "`Mara` `null` `Sajeeb Ahmed` `null`",
      },
      {
        correct: false,
  ...
  },
  {
    id: 144,
    title:
      '144. What do we need to add to the `person` object to get `["Sajeeb Ahmed", 21]` as the output of `[...person]`?',
    code: 'const person = {\n  name: "Sajeeb Ahmed",\n  age: 21\n}\n\n[...person] // ["Sajeeb Ahmed", 21]',
    options: [
      {
        correct: false,
    ...
    explanation:
      'Objects aren\'t iterable by default. An iterable is an iterable if the iterator protocol is present. We can add this manually by adding the iterator symbol `[Symbol.iterator]`, which has to return a generator object, for example by making it a generator function `*[Symbol.iterator]() {}`. This generator function has to yield the `Object.values` of the `person` object if we want it to return the array `["Sajeeb Ahmed", 21]`: `yield* Object.values(this)`.',
  },
];
